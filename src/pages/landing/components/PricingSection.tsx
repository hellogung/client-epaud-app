...
const pricingPlans = [
  {
    id: "starter",
    name: "Starter",
    description: "Cocok untuk sekolah PAUD kecil yang baru memulai digitalisasi",
    price: "Gratis",
    period: "selamanya",
    icon: Star,
    color: "epaud-cyan",
  ...
  },
  {
    id: "professional",
    name: "Professional",
    description: "Untuk sekolah PAUD yang ingin pengalaman lengkap dan profesional",
    price: "299K",
    period: "per bulan",
    icon: Zap,
    color: "epaud-orange",
  ...
  },
  {
    id: "enterprise",
    name: "Enterprise",
    description: "Solusi lengkap untuk yayasan dengan banyak sekolah PAUD",
    price: "699K",
    period: "per bulan",
    icon: Crown,
    color: "epaud-purple",
      ...
      <div className="container mx-auto px-4 lg:px-8" ref={ref}>
          ...
          {pricingPlans.map((plan, index) => (
            <motion.div
              ...
              className={`relative bg-card rounded-2xl border ${
                plan.popular
                  ? "border-epaud-orange shadow-xl shadow-epaud-orange/10"
                  : "border-border"
              } overflow-hidden`}
            >
              {/* Popular Badge */}
                ...
                <div className="mb-6">
                  <div className="flex items-baseline gap-1">
                    ...
                    <span className={`text-4xl font-black ${
                      plan.popular 
                        ? "bg-gradient-to-r from-epaud-orange to-epaud-pink bg-clip-text text-transparent"
                        : "text-foreground"
                    }`}>
                      {plan.price}
                    </span>
                  ...
                  {plan.limitations.length > 0 && (
                    <>
                      <div className="border-t border-border pt-3 mt-4">
                        <p className="text-sm font-semibold text-muted-foreground mb-2">Tidak termasuk:</p>
                        <ul className="space-y-2">
        ...
        >
          <p className="text-muted-foreground mb-4">
            Butuh paket khusus untuk kebutuhan Anda?{" "}
            <a href="#contact" className="text-epaud-orange font-semibold hover:underline">
              Hubungi kami
            </a>{" "}
