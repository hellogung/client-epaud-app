...
import { ArrowRight, Mail, Phone, MapPin, MessageCircle, Send, Heart, type LucideIcon } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Textarea } from "@/components/ui/textarea";

type ColorKey = "orange" | "pink" | "green" | "cyan";

const colorStyles: Record<ColorKey, { bg: string; text: string }> = {
  orange: { bg: "bg-epaud-orange/10", text: "text-epaud-orange" },
  pink: { bg: "bg-epaud-pink/10", text: "text-epaud-pink" },
  green: { bg: "bg-epaud-green/10", text: "text-epaud-green" },
...
const contactInfo: ContactInfo[] = [
  { icon: Mail, title: "Email", value: "hello@epaud.id", link: "mailto:hello@epaud.id", color: "orange" },
  { icon: Phone, title: "Telepon", value: "+62 812 3456 7890", link: "tel:+6281234567890", color: "pink" },
  { icon: MessageCircle, title: "WhatsApp", value: "Chat dengan kami", link: "https://wa.me/6281234567890", color: "green" },
  { icon: MapPin, title: "Lokasi", value: "Jakarta, Indonesia", link: "#", color: "cyan" },
];
        ...
        >
          ...
          <div className="relative z-10 text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-white/90 mb-8 max-w-xl mx-auto">
              Bergabung dengan ratusan sekolah PAUD. Mulai gratis!
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/register">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button size="lg" className="w-full sm:w-auto bg-white text-epaud-orange hover:bg-white/90 shadow-xl text-base px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">
              Tim kami siap membantu Anda dalam waktu 24 jam.
            </p>
            ...
            <form className="space-y-5">
              <div className="grid sm:grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  ...
                  <Input type="email" placeholder="email@sekolah.com" className="h-12" />
                </div>
              </div>

              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">Nama Sekolah</label>
                <Input placeholder="TK/PAUD/KB Anda" className="h-12" />
              </div>

              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">Pesan</label>
                <Textarea placeholder="Ceritakan kebutuhan Anda..." className="min-h-[120px] resize-none" />
              </div>
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground">Hubungi kami melalui channel yang tersedia.</p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {contactInfo.map((info, index) => {
                ...
                return (
                  ...
                  >
                    <div className={`w-12 h-12 rounded-xl ${styles.bg} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform`}>
                      <info.icon className={`w-6 h-6 ${styles.text}`} />
                    </div>
            ...
            <div className="bg-accent/50 rounded-xl p-6">
              ...
              <div className="space-y-3">
                {["Apakah ada trial gratis?", "Bagaimana cara migrasi data?", "Apakah bisa custom fitur?"].map((q, i) => (
              ...
              <p className="text-sm text-epaud-orange font-medium mt-4 hover:underline cursor-pointer">Lihat semua FAQ →</p>
            </div>
          </motion.div>
        </div>
      </div>
