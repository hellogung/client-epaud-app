      ...
      <div className="container mx-auto px-4 lg:px-8" ref={ref}>
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            ...
            EPAUD menyediakan semua fitur yang Anda butuhkan untuk mengelola sekolah PAUD modern.
          </motion.p>
        </div>

        {/* Features Interactive Display - Desktop */}
        <div className="hidden lg:grid lg:grid-cols-3 gap-8 mb-16">
              ...
              >
                ...
                <ChevronRight
                  className={`w-4 h-4 ml-auto transition-all ${
                    activeFeature.id === feature.id
                      ? `text-${feature.color} translate-x-1`
          ...
          >
            <div
              className={`w-16 h-16 rounded-2xl bg-${activeFeature.color}/20 flex items-center justify-center mb-6`}
            >
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                {activeFeature.benefits.map((benefit, i) => (
                  ...
                  >
                    <div className={`w-1.5 h-1.5 rounded-full bg-${activeFeature.color}`} />
                    {benefit}
                  </motion.li>
                ))}
              </ul>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:hidden">
          {features.map((feature, index) => (
            ...
            >
              <div
                className={`w-12 h-12 rounded-xl bg-${feature.color}/20 flex items-center justify-center mb-4`}
              >
